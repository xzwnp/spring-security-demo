...
public class R<T> {
     ...
     * @param enumCode
     */
    public void parserEnum(ResponseEnum enumCode) {
    ...
    public static <T> R<T> success(T data) {
        ...
        responseData.parserEnum(ResponseEnum.SUCCESS);
        // 放入响应数据
     ...
     */
    public static <T> R<T> error(ResponseEnum enumCode, String message, T data) {
        // 创建响应标准格式对象
        R<T> responseData = new R<T>();
        // 调用转换器方法，将（错误）枚举常量解析。
    ...
    public static <T> R<T> error(ResponseEnum enumCode, String message) {
        // 创建响应标准格式对象
        R<T> responseData = new R<T>();
        // 调用转换器方法，将（错误）枚举常量解析。
        responseData.parserEnum(enumCode);
    ...
    public static <T> R<T> error(ResponseEnum enumCode) {
        // 创建响应标准格式对象
        R<T> responseData = new R<T>();
        // 调用转换器方法，将（错误）枚举常量解析。
        responseData.parserEnum(enumCode);
